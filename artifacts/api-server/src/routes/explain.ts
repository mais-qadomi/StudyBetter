...
- افصل كل فكرة أو نقطة أو جملة مستقلة بسطر فارغ (\\n\\n) عن التي تليها.
- لا تكتب النص كتلةً واحدة متصلة؛ كل فقرة منفصلة.
- إذا كان النص يحتوي على قائمة أو خطوات، ضع كل عنصر في سطر جديد مسبوقاً بـ "•".
